...
#PBS -l place=scatter
#PBS -j oe
#PBS -o /home/yadunand/sc_2025_agents/batch_runners_2/node1.stdout
#PBS -e /home/yadunand/sc_2025_agents/batch_runners_2/node2.stderr
...
LOGDIR=/home/yadunand/sc_2025_agents/experiment_2
...
do
    ...
    do
        ...
        timeout -k 30 600 python3 fedml_test.py \
